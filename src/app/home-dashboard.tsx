...
import { BillingProvider } from "@/components/dashboard/BillingContext";
import { PromoProvider } from "@/components/dashboard/promo/PromoProvider";
import { PromoHeader } from "@/components/dashboard/promo/PromoHeader";
import { PromoCloseDialog } from "@/components/dashboard/promo/PromoCloseDialog";
        ...
        <ToastProvider>
          ...
          <div className="flex h-dvh min-h-0 w-full flex-col overflow-hidden">
            ...
            <div className="flex min-h-0 flex-1 overflow-hidden">
              <aside className="z-20 hidden h-full w-[360px] shrink-0 flex-col gap-3 overflow-hidden bg-[#f4f5f7] py-2 pl-2 pr-3 lg:flex">
            ...
            <main
              className={`min-h-0 min-w-0 flex-1 overflow-y-auto bg-transparent pb-[calc(4.5rem+env(safe-area-inset-bottom))] lg:h-full ${
                activeView === "scripts"
